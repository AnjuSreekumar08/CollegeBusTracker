...
public class DriverReg extends AppCompatActivity {
    ...
    private String subject,message,dropdownBusid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(DriverReg.this, "helloooo", Toast.LENGTH_LONG).show();
            }
        });
            ...
            public void onSuccess(AuthResult authResult) {
                ...
                reference.child("driver").child(dphone1).setValue(driver).addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        JavaMailAPI javaMailAPI=new JavaMailAPI(DriverReg.this,demail1,subject,message);

                        javaMailAPI.execute();
                        Toast.makeText(DriverReg.this, "Data Saved", Toast.LENGTH_LONG).show();
                    }
                });
